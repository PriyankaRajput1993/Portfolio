...
function openGmail() {
  const email = "rajput.priyanka1025@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Priyanka Resume.pdf"; // Path to your resume file
  link.download = "Priyanka Rajput Resume.pdf"; // Name for the downloaded file
